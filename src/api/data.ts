  ...
  subtitle: "Below are some personal and professional projects that I've worked on. Hover over the image to get some more information.",
    content: [
      ...
      },
      {
        ...
        description: "My partner and my's wedding website where guests will be able to RSVP, submit meal choices, dietary requirements, and find information related to the day. Built in Remix, React, TS, Prisma and MongoDB"
      },
      {
